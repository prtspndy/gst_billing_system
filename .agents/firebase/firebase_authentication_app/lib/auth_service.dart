...
class AuthService {
  ...
  /// Indicates if Google Sign-In is supported on the current platform.
  /// Supported only on Android, iOS, and Web.
  /// Not supported on macOS and Windows.
  ...
  /// Sign in with Google (Android, iOS, Web only).
  /// Throws [UnsupportedError] if called on an unsupported platform (e.g., macOS, Windows).
  ...
  /// Converts authentication exceptions into simple, human-readable messages.
    ...
    if (error is FirebaseAuthException) {
      switch (error.code) {
        ...
        case 'too-many-requests':
          return 'Too many attempts. Access has been temporarily disabled. Please try again later.';
